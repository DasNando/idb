...
from .base import (
    object_mapper, _class_to_mapper, _state_mapper, object_state,
    _none_set, state_str, instance_str
)
from .unitofwork import UOWTransaction
from .. import util, engine, exc as sa_exc
...
class Session(_SessionClassMethods):
    ...
    def get_bind(self, mapper=None, clause=None):
        ...
        if isinstance(clause, app.lib.sqlalchemy.sql.expression.ClauseElement) and clause.bind:
            return clause.bind
