...
// $scope.booklist = JSON.parse(Get('https://www.googleapis.com/books/v1/volumes?q=subject:technology&maxResults=40&langRestrict=en&key=AIzaSyBIbqz2Qb-Afi-v1iXP3QRdM8wQmQMdFG4'))
// console.log("got some json: "+$scope.booklist.kind)

// $scope.booklist = $http.get("http://cs373-idb.appspot.com/api/books");
